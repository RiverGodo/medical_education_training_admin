!function (e, t) {
    ...
    function h(e) {
        ...
        this.editor = e, this.$elem = o('<div class="w-e-menu wang-editor-show"><i class="w-e-icon-text-heigh"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 160,
            $title: o("<p style='color: #000'>字号</p>"),
            type: "list",
            list: [{
                $elem: o('<span style="font-size: x-small;color: #000">12</span>'),
                value: "1"
            }, {$elem: o('<span style="font-size: small;color: #000">13</span>'), value: "2"}, {
                $elem: o("<span>16</span>"),
                value: "3"
            }, {
                $elem: o('<span style="font-size: large;color: #000">18</span>'),
                value: "4"
            }, {
                $elem: o('<span style="font-size: 20px;color: #000">20</span>'),
                value: 5
            }, {
                $elem: o('<span style="font-size: x-large;color: #000">24</span>'),
                value: "6"
            }, {$elem: o('<span style="font-size: xx-large;color: #000">32</span>'), value: "7"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function B(e) {
        ...
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-list2"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p style='color: #000'>设置列表</p>"),
            type: "list",
            list: [{
                $elem: o('<span style="color: #000"><i class="w-e-icon-list-numbered"></i> 有序列表</span>'),
                value: "insertOrderedList"
            }, {$elem: o('<span style="color: #000"><i class="w-e-icon-list2"></i> 无序列表</span>'), value: "insertUnorderedList"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function y(e) {
        ...
        this.editor = e, this.$elem = o('<div class="w-e-menu"><i class="w-e-icon-paragraph-left"></i></div>'), this.type = "droplist", this._active = !1, this.droplist = new d(this, {
            width: 100,
            $title: o("<p style='color: #000'>对齐方式</p>"),
            type: "list",
            list: [{
                $elem: o('<span style="color: #000"><i class="w-e-icon-paragraph-left"></i> 靠左</span>'),
                value: "justifyLeft"
            }, {
                $elem: o('<span style="color: #000"><i class="w-e-icon-paragraph-center"></i> 居中</span>'),
                value: "justifyCenter"
            }, {$elem: o('<span style="color: #000"><i class="w-e-icon-paragraph-right"></i> 靠右</span>'), value: "justifyRight"}],
            onClick: function (e) {
                t._command(e)
            }
        })
    ...
    function C(e) {
        ...
        this._active = !1, this.droplist = new d(this, {
            width: 120,
            $title: o("<p style='color: #000'>文字颜色</p>"),
            type: "inline-block",
    ...
    function k(e) {
        this.editor = e, this.$elem = o('<div class="w-e-menu"><input type="file" accept="video/mp4" class="wangeditor-upload-input-video"><i class="w-e-icon-play"></i></div>'), this.type = "click", this._active = !1
    }
