<template>
    <div>
        ...
        <screen @resetPage="resetPage" :types="10" title="用户私信"   @handleClick="handleClick" style="background:#ffffff"/>
        ...
        data() {
            return {
                ...
                columns1: [
                    ...
                    {title: '使用次数', key: 'students_num', minWidth: 100},
                    {title: '创建时间', key: 'send_time', minWidth: 130},
                    {title: '创建人', key: 'realname', minWidth: 100},
                    {
                        ...
                        operation: [['编辑', 'operation0'], [['禁用','启用'], 'option2'],['删除', 'option3']],
                    }
                ],
                list: [],
                tableHeight: null,
