let build = (type) => {
  ...
  let webpackConfig2 = merge(webpackConfig, {
    output: {
      publicPath: type == 'production' ? config.prod.publicPath : type == 'portal' ? config.portal.publicPath : config.test.publicPath
    },
    optimization: {
      nodeEnv: type == 'production' ? 'production' : type == 'portal' ? 'portal' : 'testing'
    }
  })
